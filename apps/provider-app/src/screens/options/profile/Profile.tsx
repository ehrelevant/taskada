...
import { BadgeCheck, Camera, Eye, EyeOff, ShieldCheck, X } from 'lucide-react-native';
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          <View style={[styles.section, styles.avatarSection]}>
            ...
            <Typography variant="h3" color="textInverse" style={styles.sectionTitle}>
              Profile Picture
            </Typography>
            <Typography variant="caption" color="textInverse">
              Tap the camera icon to update your avatar.
            </Typography>
          </View>
