...
export class PaymentEngineService {
  ...
  async createSession(request: CreateSessionRequest): Promise<CreateSessionResponse> {
    ...
    return this.handleRequest(() => create_session(request));
  }
