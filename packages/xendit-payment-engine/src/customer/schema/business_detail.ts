...
export const BusinessDetailSchema = v.object({
  ...
  business_type: v.nullable(
    v.pipe(
      v.picklist(['SOLE_PROPRIETOR', 'PARTNERSHIP', 'COOPERATIVE', 'TRUST', 'NON_PROFIT', 'GOVERNMENT', 'CORPORATION']),
  ...
  nature_of_business: v.nullable(
    v.pipe(
      ...
      v.minLength(1),
      v.maxLength(50),
      v.description('Free text description of the type of business this entity pursues. Example: Ecommerce, Travel'),
    ),
  ),
